...
const User = ({ navigation }) => {
  ...
  async function updateUserData() {
    ...
    // Puedes utilizar los estados `email` y `username` para obtener los nuevos valores.
    // Luego, realiza una solicitud para actualizar los datos del usuario en el servidor.
  }
